...
const handler = createMcpHandler((server) => {
    ...
    "Call this to add a new pet to the store. Provide the pet's name, photo URLs, and optionally its ID, category, tags, and status. Returns the created pet object.",
    {
      ...
      tags: z.array(z.unknown()).describe("Tags to categorize or label the pet (optional)").optional(),
      status: z.string().describe("The current status of the pet in the store, such as available, pending, or sold (optional)").optional(),
    },
    async (params, { authInfo }) => {
      console.log('pii', {email: 'jc@gmail.com'})
  ...
  server.tool(
    "update_pet",
    "Call this to update an existing pet's information by its ID. Provide the pet's ID and the fields you want to update (name, category, photo URLs, tags, status). Returns the updated pet object.",
    {
      ...
      tags: z.array(z.unknown()).describe("Updated tags to categorize or label the pet (optional)").optional(),
  ...
  server.tool(
    ...
    "Call this to search for pets in the store by their status. Provide one or more status values (comma-separated, such as 'available,pending,sold'). Returns a list of pets matching the specified statuses.",
    {
  ...
  server.tool(
    "search_pets_by_tags",
    "Call this to search for pets in the store by their tags. Provide one or more tags (comma-separated, such as 'tag1,tag2,tag3'). Returns a list of pets matching the specified tags.",
    {
      tags: z.array(z.unknown()).describe("One or more tags to filter by, separated by commas (e.g., 'dog' or 'dog,cat')"),
    },
    async (params, { authInfo }) => {
      const creds = await fetchCredentials(authInfo?.token)
      const _params = new URLSearchParams()
  ...
  server.tool(
    "get_pet_by_id",
    "Call this to retrieve a single pet's complete information by its numeric ID. Returns the pet object with all details including name, status, category, photos, and tags.",
    {
  ...
  server.tool(
    ...
    "Call this to update a pet's name and/or status using form data. Provide the pet's ID and the fields you want to update. Returns confirmation of the update.",
    {
  ...
  server.tool(
    "delete_pet",
    "Call this to permanently delete a pet from the store by its ID. Returns confirmation that the pet has been deleted.",
    {
  ...
  server.tool(
    "upload_pet_image",
    "Call this to upload an image file for a pet. Provide the pet's ID and the image file. Optionally include additional metadata about the image. Returns confirmation of the upload.",
    {
  ...
  server.tool(
    "get_store_inventory",
    "Call this to retrieve the current inventory of pets in the store organized by status. Returns a map showing the count of pets for each status (e.g., available, pending, sold).",
    {
  ...
  server.tool(
    "create_order",
    "Call this to create a new order for a pet in the store. Provide the pet ID, quantity, and optionally the order ID, ship date, status, and completion flag. Returns the created order object.",
    {
      ...
      quantity: z.number().describe("The number of pets to order (optional)").optional(),
      shipDate: z.string().describe("The date when the order should be shipped (optional)").optional(),
      status: z.string().describe("The current status of the order, such as placed, approved, or delivered (optional)").optional(),
  ...
  server.tool(
    "get_order_by_id",
    "Call this to retrieve a single order's details by its numeric ID. Returns the order object with all information including pet ID, quantity, ship date, and status. Note: Use IDs <= 5 or > 10 for valid responses.",
    {
  ...
  server.tool(
    "delete_order",
    "Call this to permanently delete an order by its ID. Returns confirmation that the order has been deleted. Note: Use IDs < 1000 for valid responses.",
    {
  ...
  server.tool(
    ...
    "Call this to create multiple user accounts at once using a list of user objects. Provide an array of user data. Returns confirmation of the users created.",
    {
  ...
  server.tool(
    ...
    "Call this to authenticate a user and log them into the system. Provide the username and password. Returns a session token or confirmation of successful login.",
    {
      ...
      password: z.string().describe("The password for the user account in plain text").optional(),
    },
    async (params, { authInfo }) => {
      const _params = new URLSearchParams()
  ...
  server.tool(
    ...
    "Call this to retrieve a user's complete profile information by their username. Returns the user object with all details including email, phone, and status. Use 'user1' for testing.",
    {
  ...
  server.tool(
    "delete_user",
    "Call this to permanently delete a user account by their username. Returns confirmation that the user has been deleted.",
    {
