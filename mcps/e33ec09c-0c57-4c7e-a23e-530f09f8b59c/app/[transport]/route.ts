...
const handler = createMcpHandler((server) => {
  ...
  server.tool(
    ...
    "Call this to update a pet's name and/or status using form data. Provide the pet's ID and the fields you want to update. Returns success confirmation.",
    {
  ...
  server.tool(
    "upload_pet_image",
    "Call this to upload an image file for a pet. Provide the pet's ID and the image file. Optionally include additional metadata. Returns upload confirmation.",
    {
  ...
  server.tool(
    "get_order_by_id",
    "Call this to retrieve a specific order by its ID. Returns the complete order details including pet ID, quantity, ship date, and status. Use order IDs <= 5 or > 10 for valid responses.",
    {
  ...
  server.tool(
    "delete_order",
    "Call this to delete a purchase order by its ID. Returns a success confirmation. Use order IDs < 1000 for valid responses.",
    {
  ...
  server.tool(
    "logout_user",
    "Call this to log the currently logged-in user out of the system. Returns a success confirmation.",
    {
